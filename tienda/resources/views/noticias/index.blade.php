<x-layout>
    ...
    <!-- Tarjetas de las noticias llamadas de la BD -->
                ...
                <article class="col-12 mb-4">
                    <div class="card shadow-sm card-noticia overflow-hidden"
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-3">
                                <img src="{{ url('images/' . $noticia->imagen) }}" class="img-fluid h-100 object-fit-cover"
                                    alt="{{ $noticia->titulo }}"
                            ...
                            <div class="col-md-9" style="background-color: #f1f3f5;">
                                <div class="card-body d-flex flex-column justify-content-center h-100 p-3">
                                    <div>
                                        ...
                                        <h2 class="h5 card-title fw-bold mb-2 text-uppercase"
                                            style="font-family: 'Anton', sans-serif; color: #343a40;">
                                            {{ $noticia->titulo }}
                                        </h2>
                                    ...
                                    <div class="mt-3">
                                        <small class="fw-bold"
                                            style="font-size: 0.75rem; text-transform: uppercase; color: #6c757d;">
